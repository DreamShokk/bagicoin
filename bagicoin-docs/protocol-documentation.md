...
This document describes the protocol extensions for all additional functionality build into the Bagicoin protocol. This doesn't include any of the Bitcoin protocol, which has been left intact in the Bagicoin project. For more information about the core protocol, please see https://en.bitcoin.it/w/index.php?title#Protocol_documentation&action#edit
...
| 33-65 | pubKeyCollateralAddress | [CPubKey](#cpubkey) | CPubKey of the main 1000 CHC unspent output
...
| Field Size | Field Name | Data type | Description |
| ---------- | ----------- | --------- | -------- |
| 41 | vin1 | [CTxIn](#ctxin) | The unspent output which is holding 1000 CHC for masternode 1
| 41 | vin2 | [CTxIn](#ctxin) | The unspent output which is holding 1000 CHC for masternode 2
