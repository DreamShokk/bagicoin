# Support for Output Descriptors in Bagicoin Core

Since Bagicoin Core v0.17, there is support for Output Descriptors. This is a
...
on Bagicoin's OP_CHECKMULTISIG opcode. To support these, we introduce the
...
existing Bagicoin Core wallets, a convenience function `combo` is
