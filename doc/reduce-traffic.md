...
By default, Bagicoin Core allows up to 125 connections to different peers, 8 of
...
limits are tiny. Keep in mind that bagicoin's trustless model works best if you are
