...
This document provides guidelines for internationalization of the Chaincoin Core software.
...
This adds `<numerusform>`s to the respective `.ts` file, which can be translated separately depending on the language. In English, this is simply:
    ...
    <message numerus="yes">
        ...
        <translation>
            <numerusform>%n active connection to Chaincoin network</numerusform>
            <numerusform>%n active connections to Chaincoin network</numerusform>
        </translation>
    </message>
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `chaincoin_en.ts` remains unchanged.
