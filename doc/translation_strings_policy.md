...
This document provides guidelines for internationalization of the Bagicoin Core software.
...
This adds `<numerusform>`s to the respective `.ts` file, which can be translated separately depending on the language. In English, this is simply:
    ...
    <message numerus="yes">
        ...
        <translation>
            <numerusform>%n active connection to Bagicoin network</numerusform>
            <numerusform>%n active connections to Bagicoin network</numerusform>
        </translation>
    </message>
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `bagicoin_en.ts` remains unchanged.
