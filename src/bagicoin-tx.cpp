...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || HelpRequested(gArgs)) {
        ...
        std::string strUsage = PACKAGE_NAME " bagicoin-tx utility version " + FormatFullVersion() + "\n\n" +
            "Usage:  bagicoin-tx [options] <hex-tx> [commands]  Update hex-encoded bagicoin transaction\n" +
            "or:     bagicoin-tx [options] -create [commands]   Create hex-encoded bagicoin transaction\n" +
            "\n";
