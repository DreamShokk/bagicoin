...
namespace
{
/// Internal LUFFA512 implementation.
namespace luffa512
{

void inline Initialize(luffa_context *sc, const sph_u32 *iv)
{
    memcpy(sc->V, iv, sizeof(sc->V));
    sc->ptr = 0;
}
...
CLUFFA512::CLUFFA512()
{
    luffa512::Initialize(&s, *V_INIT);
}

CLUFFA512& CLUFFA512::Write(const unsigned char* data, size_t len)
{
    unsigned char *buf;
    size_t ptr;
    DECL_STATE5
...
void CLUFFA512::Finalize(unsigned char hash[OUTPUT_SIZE])
{
    unsigned char *buf;
    size_t ptr;
    unsigned z;
    ...
    for (int i = 0; i < 3; i ++) {
        ...
        case 0:
            ...
            break;
        case 1:
            sph_enc32be(hash +  0, V00 ^ V10 ^ V20 ^ V30 ^ V40);
            sph_enc32be(hash +  4, V01 ^ V11 ^ V21 ^ V31 ^ V41);
            sph_enc32be(hash +  8, V02 ^ V12 ^ V22 ^ V32 ^ V42);
            sph_enc32be(hash + 12, V03 ^ V13 ^ V23 ^ V33 ^ V43);
            sph_enc32be(hash + 16, V04 ^ V14 ^ V24 ^ V34 ^ V44);
            sph_enc32be(hash + 20, V05 ^ V15 ^ V25 ^ V35 ^ V45);
            sph_enc32be(hash + 24, V06 ^ V16 ^ V26 ^ V36 ^ V46);
            sph_enc32be(hash + 28, V07 ^ V17 ^ V27 ^ V37 ^ V47);
            break;
        case 2:
            sph_enc32be(hash + 32, V00 ^ V10 ^ V20 ^ V30 ^ V40);
            sph_enc32be(hash + 36, V01 ^ V11 ^ V21 ^ V31 ^ V41);
            sph_enc32be(hash + 40, V02 ^ V12 ^ V22 ^ V32 ^ V42);
            sph_enc32be(hash + 44, V03 ^ V13 ^ V23 ^ V33 ^ V43);
            sph_enc32be(hash + 48, V04 ^ V14 ^ V24 ^ V34 ^ V44);
            sph_enc32be(hash + 52, V05 ^ V15 ^ V25 ^ V35 ^ V45);
            sph_enc32be(hash + 56, V06 ^ V16 ^ V26 ^ V36 ^ V46);
            sph_enc32be(hash + 60, V07 ^ V17 ^ V27 ^ V37 ^ V47);
            break;
        }
    }
    Reset();
