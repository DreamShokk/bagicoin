...
namespace
{
/// Internal SKEIN512 implementation.
namespace skein512
{

void inline Initialize(skein_context *sc, const sph_u64 *iv)
{
    sc->h0 = iv[0];
    sc->h1 = iv[1];
    sc->h2 = iv[2];
...
CSKEIN512::CSKEIN512()
{
    skein512::Initialize(&s, IV512);
}

CSKEIN512& CSKEIN512::Write(const unsigned char* data, size_t len)
{
    /*
...
void CSKEIN512::Finalize(unsigned char hash[OUTPUT_SIZE])
{
    unsigned char *buf;
    size_t ptr;
    unsigned et;
