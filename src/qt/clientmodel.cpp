...
void ClientModel::subscribeToCoreSignals()
{
    ...
    m_handler_notify_masternode_changed = m_node.handleMasternodeChanged(std::bind(NotifyMasternodeChanged, this, std::placeholders::_1, std::placeholders::_2));
    m_handler_notify_proposal_changed = m_node.handleProposalChanged(std::bind(NotifyProposalChanged, this, std::placeholders::_1, std::placeholders::_2));
}
