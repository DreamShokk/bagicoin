    ...
    ui(new Ui::HelpMessageDialog)
{
    ...
    if (helpMode == about)
    {
        ...
        setWindowTitle(tr("CoinJoin information"));
...
It can only do this automatically, however, if you have automatic backups enabled.<br> \
Consequently, users who have backups disabled will also have CoinJoin disabled. <hr>\
For more info see <a href=\"https://coinjoin.biz\">https://coinjoin.biz</a> \
        "));
        ui->aboutMessage->setWordWrap(true);
        ui->helpMessage->setVisible(false);
        ui->aboutLogo->setVisible(false);
