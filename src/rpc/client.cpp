...
static const CRPCConvertParam vRPCConvertParams[] =
{
    ...
    { "walletcreatefundedpsct", 0, "inputs" },
    { "walletcreatefundedpsct", 1, "outputs" },
    { "walletcreatefundedpsct", 2, "locktime" },
    { "walletcreatefundedpsct", 3, "options" },
    { "walletcreatefundedpsct", 4, "bip32derivs" },
    { "walletprocesspsct", 1, "sign" },
    { "walletprocesspsct", 3, "bip32derivs" },
    { "createpsct", 0, "inputs" },
    { "createpsct", 1, "outputs" },
    ...
    { "prepareproposal", 1, "revision" },
    { "prepareproposal", 2, "time" },
