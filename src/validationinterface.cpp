...
void RegisterValidationInterface(CValidationInterface* pwalletIn) {
    ...
    conns.ProcessModuleMessage = g_signals.m_internals->ProcessModuleMessage.connect(boost::bind(&CValidationInterface::ProcessModuleMessage, pwalletIn, _1, _2, _3, _4));
    conns.NotifyGovernanceObject = g_signals.m_internals->NotifyGovernanceObject.connect(boost::bind(&CValidationInterface::NotifyGovernanceObject, pwalletIn, _1));
    conns.NotifyGovernanceVote = g_signals.m_internals->NotifyGovernanceVote.connect(boost::bind(&CValidationInterface::NotifyGovernanceVote, pwalletIn, _1));
}
