...
BOOST_FIXTURE_TEST_SUITE(psct_wallet_tests, WalletTestingSetup)

BOOST_AUTO_TEST_CASE(psct_updater_test)
{
    ...
    bool complete = true;
    BOOST_REQUIRE_EQUAL(TransactionError::OK, FillPSCT(&m_wallet, psctx, complete, SIGHASH_ALL, false, true));
